#!/bin/bash
#SBATCH --job-name=bootstrap-hurts-CLAP
#SBATCH --nodes=1
...
#
#   sbatch scripts/bootstrap-hurts-CLAP.sh
#   sbatch scripts/bootstrap-hurts-CLAP.sh --k 5
#   sbatch scripts/bootstrap-hurts-CLAP.sh --resume
#
...
python -u eval_bootstrap_hurts.py "$@"
